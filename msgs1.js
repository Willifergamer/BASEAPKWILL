module.exports = configMsg = async (body, reply,) => {
 switch(body.toLowerCase()){
       
        case "nao":
        reply(` Ok entendi, bom como prefere que eu te explique? 
        ...
        🚨 COMIGO VC APRENDE A FAZER TRÁFEGO PAGO SO FICA SEM CLIENTES SE FOR PREGUIÇOSO 💸
         # VC PAGA 8 REAIS EM CADA USUÁRIO E VENDE A 15$ OU A 20$ ou 30$ ...
        ...
        LINK DO MEU CONTATO PARA SUPORTE ➡️t.me/Willifergam
